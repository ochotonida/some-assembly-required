...
public class ModRecipeTypes {
    ...
    public static RegistryObject<RecipeType<SandwichSpoutingRecipe>> SANDWICH_SPOUTING = RECIPE_TYPES.register("sandwich_spouting", () -> RecipeType.simple(Util.id("sandwich_spouting")));
