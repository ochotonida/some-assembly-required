...
public class ModAdvancementTriggers {
    ...
    public static ItemTrigger ADD_POTION_TO_SANDWICH = new ItemTrigger(Util.id("add_potion_to_sandwich"));
    public static ItemTrigger CONSUME_DOUBLE_DECKER_SANDWICH = new ItemTrigger(Util.id("consume_double_decker_sandwich"));
    public static ItemTrigger CONSUME_BLT_SANDWICH = new ItemTrigger(Util.id("consume_blt_sandwich"));
