...
public class ModItems {
    ...
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, SomeAssemblyRequired.MODID);
    ...
    public static RegistryObject<CreativeModeTab> CREATIVE_TAB = CREATIVE_MODE_TABS.register("main", () -> CreativeModeTab.builder()
            ...
            .title(Component.translatable("%s.creative_tab".formatted(SomeAssemblyRequired.MODID)))
    ...
    private static void fillCreativeTab(CreativeModeTab.ItemDisplayParameters parameters, CreativeModeTab.Output output) {
        ForgeRegistries.ITEMS.getValues()
                ...
                .filter(item -> {
                    ...
                    return namespace.equals(SomeAssemblyRequired.MODID);
                })
